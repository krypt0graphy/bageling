...
public class ModFoodProperties {
    ...
    public static final FoodProperties APPLE_JAM_BAGEL = new FoodProperties.Builder().nutrition(7).saturationMod(0.4f).alwaysEat().effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 300, 0, false, false), 1F).fast().build();

    public static final FoodProperties SWEET_BERRY_JAM_BAGEL = new FoodProperties.Builder().nutrition(7).saturationMod(0.4f).alwaysEat().effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 300, 0, false, false), 1F).fast().build();
    ...
    public static final FoodProperties APPLE_JAM_BAGEL_NO_FD = new FoodProperties.Builder().nutrition(7).saturationMod(0.4f).fast().build();

    public static final FoodProperties SWEET_BERRY_JAM_BAGEL_NO_FD = new FoodProperties.Builder().nutrition(7).saturationMod(0.4f).fast().build();
